...
/**
 * An implementor of {@link Tuple} consisting of ten elements, which can be seen as a cartesian product across all of
 * its elements.
 *
 ...
 * @param _10   the value contained in the tenth element
 ...
 * @param <T10> the type of the value contained in the tenth element
 */
